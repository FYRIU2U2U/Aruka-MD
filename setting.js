...
global.nomerOwner ="628" //nomor kamu
global.nomerOwner2 = "628" //ini juga mau sama mau beda terserah
global.ownerName = "Queen Elisa" //namankamu buat di owner
global.namabot = "© Queen Elisa BOT" //nama bot kamu
global.botName = "© Queen Elisa MD ν2" // ini juga
global.fake = "© Queen Elisa MD ν2" // ini juga terserah
...
global.authorName = "Created By Queen Elisa BOT" //ini juga buat stiker
global.namastore = "Elisa Store" // terserah
global.nodana = "" //nomor kamu
global.nogopay = "-" //nomor kamu
global.noovo = "-" // yang inu juga
global.qris = "-" // ini juga
global.TextT = `Elisa Bot` //terserah
global.textT = `Elisa Bot` //bodoamat
global.sgc = ' '
global.syt = ''
global.sig = ''
// --------- SETTING OWNER -------- //
